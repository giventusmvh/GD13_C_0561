...
class AddEditActivityTest {
    ...
    fun addEditActivityTest() {
        ...
        textInputEditText.perform(scrollTo(), replaceText("Given"), closeSoftKeyboard())
        ...
        textInputEditText2.perform(scrollTo(), replaceText("200710561"), closeSoftKeyboard())
